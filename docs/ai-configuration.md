...
> Cybermaps 7.4.2 · AI Configuration Brief format 2
...
- JSON Schema: `https://cybermaps.dev/specs/ai-configuration/7.4.2/schema.json`
- Field catalog: `https://cybermaps.dev/specs/ai-configuration/7.4.2/catalog.json`
...
For Cybermaps 7.4.2, the public machine contracts are:

- `https://cybermaps.dev/specs/ai-configuration/7.4.2/schema.json`
- `https://cybermaps.dev/specs/ai-configuration/7.4.2/catalog.json`
